...
export class AddressResolverBase {
  ...
  async createAddress(
    ...
    return await this.service.createAddress({
      ...
      data: {
        ...
        principalAddresses: args.data.principalAddresses
          ? {
              connect: args.data.principalAddresses,
            }
          : undefined,

        secondaryAddresses: args.data.secondaryAddresses
          ? {
              connect: args.data.secondaryAddresses,
            }
          : undefined,
      },
    });
  ...
  async getPrincipalAddresses(
    @graphql.Parent() parent: Address
  ): Promise<Domiciliation | null> {
    const result = await this.service.getPrincipalAddresses(parent.id);
  ...
  async getSecondaryAddresses(
    @graphql.Parent() parent: Address
  ): Promise<Transfer | null> {
    const result = await this.service.getSecondaryAddresses(parent.id);
